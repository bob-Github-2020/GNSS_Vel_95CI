...
# Last updated: 05-08-2022, by G. Wang and B. Cornelison
...
# -----------------------------------------------------------------------------
    if output == 'on':
       ...
       fig3.text(0.6,0.07, 'Si='+str_c0+str_c1+'cos(2$\pi$(ti-t0))' + str_d1+'sin(2$\pi$(ti-t0))'+str_c2+'cos(4$\pi$(ti-t0))'+str_d2+'sin(4$\pi$(ti-t0))', ha='center', va='center', transform=fig3.transAxes)
       ...
       fig4.set_xlabel('Year', fontsize=15)
