#! /usr/bin/python3
# 12-26-2021, add RMS for others
# Last updated: 12-10-2021, by G. Wang and B. Cornelison
...
# -----------------------------------------------------------------------------
    ...
    # cal annual and hal-annual amplitudes
...
# -----------------------------------------------------------------------------
    if output == 'on':
       ...
       fig3.text(0.7,0.07, 'S='+str_c0+str_c1+'cos(2$\pi$(x-x0))' + str_d1+'sin(2$\pi$(x-x0))'+str_c2+'cos(4$\pi$(x-x0))'+str_d2+'sin(4$\pi$(x-x0))', ha='center', va='center', transform=fig3.transAxes)
       fig3.text(0.1, 0.9, 'RMS: '+ str_RMS_rm_LNL + ' mm', ha='center', va='center', transform=fig3.transAxes)
       fig3.text(0.6, 0.9, 'Annual Amplitude: '+ str_P1 + ' mm', ha='center', va='center', transform=fig3.transAxes)
       fig3.text(0.85, 0.9, 'Semi-Annual Amplitude: '+ str_P2 + ' mm', ha='center', va='center', transform=fig3.transAxes)
